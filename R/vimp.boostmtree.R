...
##' individually or a joint VIMP is calulated for all the covariates specfied
##' in \code{x.names}.
##' 
...
##' @param joint Estimate individual VIMP for each covariate from
##' \code{x.names} or a joint VIMP for all covariates combine.
