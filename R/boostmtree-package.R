...
##' surgery. Patients were randomized into two groups: mitral valve surgery
##' with ablation and mitral valve surgery without ablation. Patients in the
##' ablation group were further randomized into two types of procedure:
##' pulmonary vain isolation (PVI) and biatrial maze procedure. These patients
##' were followed weekly for a period of 12 months. The primary outcome of the
##' study is the presence/absence of AF (binary longitudinal response). Data
##' includes 228 patients. From 228 patients, 7949 AF measurements are
##' available with average of 35 measurements per patient.
##' 
##' 
##' @name AF
##' @docType data
...
##' mitral valve surgery. \emph{The New England Journal of Medicine}
...
##' ordinal.  Covariate-time interactions are modeled using penalized B-splines
...
##' expiratory volume (FEV1-percentage of predicted) after lung transplant from
##' 509 patients who underwent lung transplant (LTx) at the Cleveland Clinic.
##' Twenty three patient/procedure variables were collected at the time of the
##' transplant.  The major objectives are to evaluate the temporal trend of
##' FEV1 after LTx, and to identify factors associated with post-LTx FEV1 and
