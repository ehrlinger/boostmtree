...
##' \code{xvar.names} against the adjusted predicted y-values over a set of
##' time points specified by \code{tm.unq}.  Analysis can be restricted to a
##' subset of the data using \code{subset}. Further conditioning can be imposed
##' using \code{conditional.xvars}.
##' 
##' @param object A boosting object of class \code{(boostmtree, grow)}.
##' @param M Fixed value for the boosting step number. If NULL, then use Mopt
...
##' \code{xvar.names}.
##' @param npts Maximum number of points used for x.  Reduce this value if
##' plots are slow.
...
##' @references Friedman J.H. Greedy function approximation: a gradient
